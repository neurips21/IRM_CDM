...
from utils import read_processed_image_data
...
def get_train_examples(data_dir):
    ...
    for train_env in train_envs:
        ...
        examples = read_processed_image_data(train_env)
        # if prev_length:
...
def get_test_examples(data_dir):
    ...
    for test_env in test_envs:
        ...
        examples = read_processed_image_data(test_env)
